...
public class DailyTaskCell : MonoWithEvent
{
    ...
    private void Awake()
    {
        ...
        {
            var _TaskID = (int)o;
            if (_TaskID == m_GameTaskData.m_TaskID)
        ...
        m_EventGroup.Register(LogicEvent.DailyTaskProcessChanged, (i, o) =>
        {
            ...
            if (_TaskID == m_GameTaskData.m_TaskID)
            {
                ...
                m_TaskProcess.fillAmount = m_GameTaskData.m_TaskProcess / (float)m_TaskData.TargetBaseCount;
            }
        });
    ...
    private IEnumerator Refresh()
    {
        ...
        switch ((TaskState)m_GameTaskData.m_TaskState)
        {
    ...
    public void OnClickGet()
    {
        ...
        {
            NetworkManager.Ins.SendMsg(new C2S_TaskGetReward { m_IsMain = false, m_TaskID = m_GameTaskData.m_TaskID });
        }
    }
}
