...
namespace Logic.UI.UIUser
{
    public class PartPartner : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            m_EventGroup.Register(LogicEvent.PartnerAllEffectUpdate,
                (i, o) =>
                {
                    m_HaveEffect.text =
                        "攻击力+" + ((BigDouble)(PartnerManager.Ins.AllHaveEffect * 100)).ToUIStringFloat() + "%";
                });
        }
        ...
        {
            var Index = ((S2C_PartnerOn)arg2).Index;
            var _OnList = PartnerManager.Ins.PartnerOnList;
        ...
        {
            var Index = ((S2C_PartnerOff)arg2).Index;
