    ...
    public class UIArmor : UIPage
    {
        ...
        private void Awake()
        {
            m_EventGroup.Register(LogicEvent.EquipOn, (i, o) =>
            {
                ...
                if(_Msg.m_Type == ItemType.Armor)
                    UpdateEquip();
            });
            m_EventGroup.Register(LogicEvent.EquipArmorUpgraded, (i, o) => { UpdateEquip(); });
            m_EventGroup.Register(LogicEvent.EquipAllHPEffectUpdate, (i, o) =>
            {
                m_ALLHaveEffect.text = "体力+"+((BigDouble)(EquipManager.Ins.AllHaveHPEffect * 100)).ToUIStringFloat() + "%";
            });
        ...
        private void UpdateEquip()
        {
            ...
            m_HaveEffect.text = "+" + ((BigDouble)(EquipManager.Ins.GetHaveEffect(_EquipData.ID, ItemType.Armor) * 100f)).ToUIStringFloat() + "%";
            m_EquipEffect.text = "+" + ((BigDouble)(EquipManager.Ins.GetEquipEffect(_EquipData.ID, ItemType.Armor) * 100f)).ToUIStringFloat() + "%";
        ...
        public void OnClickOn()
        {
            ...
            EquipManager.Ins.DoOn(_EquipData.ID, ItemType.Armor);
        }
        ...
        public void OnClickUpgrade()
        {
            ...
            EquipManager.Ins.DoIntensify(_EquipData.ID, ItemType.Armor, false);
        }
        ...
        public void OnClickAuto()
        {
            if(EquipManager.Ins.HaveCanUpgradeEquip(ItemType.Armor))
                EquipManager.Ins.DoIntensify(0, ItemType.Armor, true);
            else
