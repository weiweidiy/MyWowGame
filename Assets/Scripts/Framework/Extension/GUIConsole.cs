...
namespace Framework.Extension
{
    public class GUIConsole
    {
        ...
        public static void OnGUI()
        {
            ...
            if (GUI.Button(new Rect(30, 10, 100, 30), btnName))
                _visible = !_visible;
            if (GUI.Button(new Rect(130, 10, 100, 30), "Clear"))
                _logs.Clear();
            ...
            _scrollViewPos = GUILayout.BeginScrollView(_scrollViewPos, GUILayout.Width(scrollWidth),
